	...
	return new Promise((resolve, reject) => {
		...
		uni.getLocation({
			...
			success: function(res) {
				...
				try {
					res.address_2 = (res.address.province === res.address.city ? '' : res.address.province) + res.address.city + res.address.district + res.address.street + res.address.streetNum + res.address.poiName
				} catch (error) {
					res.address_2 = '解析失败'
				}
