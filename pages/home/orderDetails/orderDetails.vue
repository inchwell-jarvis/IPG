	...
	<view class="box">
		...
		<view class="Customer">
			...
			<view class="Mini_list" @longtap="CopyText(Data.Phone)" @tap='Tel(Data.Phone)'>
				...
				<view class="Mini_list_right">
					{{Data.Phone}}<span style='color: #007AFF;'>点击呼叫</span>
				</view>
			</view>
			...
			<view class="Mini_list" @longtap="CopyText(Data.OEMEngineerMobile)" @tap='Tel(Data.OEMEngineerMobile)'>
				...
				<view class="Mini_list_right">
					{{ Data.OEMEngineerMobile || ' - - '	}}<span style='color: #007AFF;'>点击呼叫</span>
				</view>
			</view>
		...
		<u-button v-if='!this.Data.HaveInProgress' size='medium' style='margin: 20px auto;display: block;width: 80%;'
			type="primary" @tap='OpenWorkOrderState = true'>开启工单</u-button>
		<u-modal v-model="OpenWorkOrderState" :content="content1"  show-cancel-button	@confirm='OpenWorkOrder()'></u-modal>


		<u-button v-if='!this.Data.HaveInProgress' size='medium' style='margin: 20px auto;display: block;width: 80%;'
			type="error" @tap='UpdateSRCStateState = true'>作废工单</u-button>
